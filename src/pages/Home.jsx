...
function Home() {
  ...
  return (
    <div className="pt-1">
      ...
      <hr className="ml-12 w-[972px] max-sm:w-[360px] max-sm:ml-0" />

      <div className="flex flex-row gap-[60px]">
        <div className="w-[22.5rem] ml-12 mt-[30px]">
          <div className="flex flex-row gap-[1rem] items-center w-[22.31rem] h-[10.5rem] border-b border-[#D9D9D9]">
            <img src={profile} alt="" width={120} height={120} />
            <div className="flex flex-col">
              <div>
                <div className="[font-family:'Arimo'] mt-[1px] w-[5.43rem] h-[2.125rem] text-[#FFF] bg-[#740AC7] justify-center gap-[1rem]  px-[0.275rem] py-[0.5rem] rounded-lg  text-center text-[0.75rem] text-normal leading-[1.125rem] pointer hover:shadow-md">
                  Super Admin
                </div>
              </div>
          ...
          <div className="flex gap-[0.6rem] flex-col mt-[0.6rem]">
            {settingsArray.map((data, index) => {
              return (
                <div
                  className="[font-family:'Arimo']  w-[22.375rem] h-[3.75rem] justify-center items-center bg-[#EEE] color-[#040404] text-[1rem] font-normal px-[0.75rem] py-[1rem] rounded-md leading-[1.2rem]  hover:bg-gray-200 transition duration-300 ease-in-out hover:shadow-xl pointer"
                  key={index}
                >
                  {data}
                </div>
