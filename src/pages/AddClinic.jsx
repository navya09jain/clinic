...
const TextInput = ({ placeholder }) => (
  <input
    className="font-inter text-base font-normal leading-22 tracking-normal text-left
              w-[221.5px] h-[22px] bg-[#ECECEC] p-4 gap-12 border border-gray-300 rounded"
    type="text"
...
const CustomButton = ({ text, width }) => {
  ...
  return (
    <button
      className={`w-${width} h-[44px] rounded-[10px] p-[10px] gap-[10px] mr-2 mt-2 text-black ${
...
export default function AddClinic() {
  return (
    <div className="w-[619px] h-[1050px] top-[172px] left-[762px] bg-[#F5F5F5] pt-12 pl-12">
      <div className="w-[523px] h-[646px] top-42 left-48 gap-16">
        ...
        <div className="w-[523px] h-[111px]  border-solid border-0 border-b-[1px] border-[#C6C6C6] gap-8">
          <div className="w-[523px] h-[22px] leading-[21.78px] text-[18px] font-inter mt-1">
            Languages
          </div>
          ...
          <div className="w-[523px] h-[170px]  border-b border-solid border-gray-300 gap-12">
            <div className="w-[523px] h-[22px] font-inter font-600 text-[18px] text-black leading-[21.78px] mt-8">
              Clinic's Consultation Rate
            </div>
            <div className="w-[523px] h-[54px] flex flex-row">
              ...
              <input
                placeholder="0.00"
                className="w-[171px] h-[54px] p-[16px] gap-[12px] bg-[#ECECEC]"
              ></input>
            ...
            <div className="w-[523px] h-[54px] flex flex-row mt-6">
            ...
            <div className="w-full h-[240px] p-0 pb-12 border-b border-solid border-gray-300 gap-12">
              ...
              <div className="w-[523px] h-[194px] gap-[16px] mt-2 flex flex-col">
                <input
                  ...
                  className="w-[523px] h-[54px] p-[16px] bg-[#ECECEC]"
                ></input>
                <input
                ...
                <div className="flex flex-row gap-[12px]">
                  <input
                    placeholder="City"
                    className="w-[253.5px] h-[54px] p-[16px] bg-[#ECECEC] gap-[12px] "
                  ></input>
                  <input
                    placeholder="Pincode"
                    className="w-[253.5px] h-[54px] p-[16px] bg-[#ECECEC] gap-[12px] "
